          ...
          <form class="" action="<?php echo base_url('register/doregister')?>" method="post">
            ...
            <div class="mdl-grid">
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                <span class="mdl-card__title-text text-color--smooth-gray">MayKe Soluciones</span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                <span class="login-name text-color--white">Regístrate</span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">

                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                  <input class="mdl-textfield__input" type="text" id="name" name="name" value="<?php echo $name ?>">
                  <label class="mdl-textfield__label" for="name">Nomnbre y Apellido</label>
                </div>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                  ...
                  <label class="mdl-textfield__label" for="password">Repite Contraseña</label>
                </div>
                ...
                <span class="login-link">Acepto todas las declaraciones de <a href="#" class="underlined">terminos de servicio</a></span>
              </div>
