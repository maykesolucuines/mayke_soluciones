...
defined('MQTT_USER') OR define('MQTT_USER', 'Y2diquHW4v13ds1');
defined('MQTT_PASSWORD') OR define('MQTT_PASSWORD', 'LlC6X576N8lm0BJ');
defined('ROOT_TOPIC') OR define('ROOT_TOPIC', '5QGOwniXAhjRNiF');
*/


//credenciales MQTT que obtendras del nodo creado en https://shiftr.io/
defined('MQTT_USER') OR define('MQTT_USER', 'mayke_iot');
defined('MQTT_PASSWORD') OR define('MQTT_PASSWORD', 'Mk121988181994');
defined('ROOT_TOPIC') OR define('ROOT_TOPIC', 'TglXAW3jvUC2UJ0');
